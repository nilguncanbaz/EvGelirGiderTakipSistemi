            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Gider Listesi</h4>
                            </div>
                            <div class="content">
												...
												<div class="form-group">
                                                    ...
                                                    <?php
														include "../../database/dconfig.php";
                                                            ...
                                                            echo "<label>Silinecek Gider ID</label>";
															echo"<input type='text' name= 'gidersil' class='form-control' placeholder='silinecek id'required>";
															echo" <input id='gsilID' class='buton-class' type='submit' name='gsil' value='Sil'></br>";
															
															if(isset($_POST["gsil"])){
                                                                $silinecekID=$_POST["gidersil"];
                                                                
																$query= $database_connection->query("DELETE FROM giderler where id='$silinecekID' ", PDO::FETCH_ASSOC);

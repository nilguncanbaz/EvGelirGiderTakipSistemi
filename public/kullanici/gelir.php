                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form method= "POST" action ="" name="frm4" >
									...
									<div class="col-md-4">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name= "gelir" class="form-control" placeholder="Gelir Tutarı" value="" required >
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <button type="submit" name="gelirEkle" class="btn btn-info btn-fill pull-right">Gelir Ekle</button>
                                    <div class="clearfix"> 
								 ...
								 include "../../database/dconfig.php";
									if(isset($_POST['gelirEkle'])){
										...
										$baslik=$_POST["baslik"];
										$uyeid=$_SESSION["ID"];
										$query=$database_connection->query("INSERT INTO gelirler VALUES (NULL,'$uyeid','$baslik', '$aciklama', '$gelir', '$tarih')", PDO::FETCH_ASSOC);
										if($query->rowCount()){
											echo "Kayıt başarılı..";
